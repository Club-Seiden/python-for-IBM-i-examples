...
# - Make sure you have installed 5733OPS PTF SI59051, SI60563, and SI62877 (or subsequent PTF's)!
...
try:
    ...
    # This flavor requires ibm_db 2.0.5.5, which you get via SI62877 and the 'pip3' command referenced earlier. 
    conn = dbi.connect()
